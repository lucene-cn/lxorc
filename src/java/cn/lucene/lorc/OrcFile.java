...
import cn.lucene.lorc.impl.HadoopShimsFactory;
import cn.lucene.lorc.impl.KeyProvider;
import cn.lucene.lorc.impl.MemoryManagerImpl;
import cn.lucene.lorc.impl.OrcTail;
import cn.lucene.lorc.impl.ReaderImpl;
import cn.lucene.lorc.impl.WriterImpl;
import cn.lucene.lorc.impl.WriterInternal;
import cn.lucene.lorc.impl.writer.WriterImplV2;
...
public class OrcFile {
   ...
   * @throws IOException
   */
  public static Writer createWriter(Path path,FSDataOutputStream output,
                                    WriterOptions opts
                                    ) throws IOException {
    ...
    switch (opts.getVersion()) {
      case V_0_11:
      case V_0_12:
        return new WriterImpl(  path,output, opts);
      case UNSTABLE_PRE_2_0:
        return new WriterImplV2(  path,output, opts);
      default:
